...
var KTModalNewTicket = function () {
    ...
    return {
        init: function () {
            (a = document.querySelector("#kt_modal_new_ticket")) && (o = new bootstrap.Modal(a), i = document.querySelector("#kt_modal_new_ticket_form"), t = document.getElementById("kt_modal_new_ticket_submit"), e = document.getElementById("kt_modal_new_ticket_cancel"),
                new Dropzone("#kt_modal_create_ticket_attachments", {
                    url: uploadUrl,
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content // توکن CSRF
                    },
                    paramName: "file",
                    maxFiles: 10,
                    maxFilesize: 10, // MB
                    ...
                    success: function(file, response) {
                        ...
                        document.querySelector('#kt_modal_new_ticket_form').appendChild(input);
                    },
                    error: function (file, response) {
                        console.error("خطا در آپلود:", response);
                    }
