(function ($, window, document, undefined) {
  ...
  $.fn.imageuploadify = function (opts) {
    ...
    this.each(function () {
      ...
      let counter = 0;
      let dragbox = $(
        `<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i><span class='imageuploadify-message'>برای آپلود فایلها ؛ آنها را اینجا بکشید و رها کنید</span><button type="button"class="btn btn-default">یا با کلیک روی این دکمه فایلهای خود را انتخاب کنید</button></div></div>`
      );
