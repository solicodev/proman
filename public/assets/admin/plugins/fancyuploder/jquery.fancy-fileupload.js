...
(function ($) {
    ...
    $.fn.FancyFileUpload = function (options) {
        ...
        $(document).off("drop.fancy_fileupload dragover.fancy_fileupload");
        $(document).on(
            "drop.fancy_fileupload dragover.fancy_fileupload",
            function (e) {
                e.preventDefault();
            }
        );
        ...
        var AddFile = function (uploads, e, data) {
            ...
            var filename =
                pos > -1
                    ? data.files[0].name.substring(0, pos)
                    : data.files[0].name;
            var fileext =
                pos > -1
                    ? data.files[0].name.substring(pos + 1).toLowerCase()
                    : "";
            ...
            var StartUpload = function (e) {
                ...
                if (settings.edit && !data.ff_info.errors.length) {
                    var fileinput = inforow.find(
                        ".ff_fileupload_filename input"
                    );
                    if (fileinput.length) {
                ...
                inforow
                    ...
                    .attr(
                        "aria-label",
                        Translate("Cancel upload and remove from list")
                    );
            ...
            if (settings.accept) {
                ...
                if (!found)
                    data.ff_info.errors.push(
                        Translate("Invalid file extension.")
                    );
            }
            ...
            data.ff_info.progressbar = inforow.find(
        ...
        var UploadProgress = function (e, data) {
            var progress =
                data.total < 1 ? 0 : (data.loaded / data.total) * 100;
            ...
            if (
                ...
                settings.continueupload.call(data.ff_info.inforow, e, data) ===
                    false
            )
                data.abort();
        };
        ...
        var UploadFailed = function (e, data) {
            ...
            if (data.ff_info.removewidget) {
                ...
                if (data.errorThrown === "abort")
                    data.ff_info.errors.push(
                        Translate("The upload was cancelled.")
                    );
            ...
            if (data.ff_info) {
                if (
                    ...
                    if (
                        ...
                        data.ff_info.lastresult.success
                    ) {
                        data.ff_info.lastresult = {
                            success: false,
                        };
        ...
        return this.each(function () {
            ...
            var dropzonetools = $("<div>").addClass(
            ...
            if (
                ...
                var audiobutton = $("<button>")
                    ...
                    .attr(
                        "aria-label",
                        Translate("Record audio using a microphone")
                    );
            ...
            if (
                ...
                var videobutton = $("<button>")
                    ...
                    .attr(
                        "aria-label",
                        Translate("Record video using a camera")
                    );
                ...
                videobutton.click(function (e) {
                    ...
                    if (!videorec) {
                        var streamhandler = function (stream) {
                            videorec = new MediaRecorder(
                                stream,
                                settings.videosettings
                            );

                            videorec.addEventListener(
                                "dataavailable",
                                function (e) {
                                    if (e.data.size > 0)
                                    ...
                                    if (videorec.state === "inactive") {
                                        ...
                                        videobutton.removeClass(
                                            "ff_fileupload_recording"
                                        );
                                        videorecpreview.addClass(
