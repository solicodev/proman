    ...
    $("#table").DataTable({
        language: {
            ...
            buttons: {
                ...
                print: "چاپ",
                copyKeys:
                    "برای کپی داده جدول در حافظه سیستم کلید های ctrl یا ⌘ + C را فشار دهید",
                csv: "فایل CSV",
                pdf: "فایل PDF",
            ...
            editor: {
                ...
                multi: {
                    restore: "واگرد",
                    noMulti:
                        "این ورودی را می توان به صورت جداگانه ویرایش کرد، اما نه بخشی از یک گروه",
                    title: "مقادیر متعدد",
                    info: "مقادیر متعدد",
                },
                error: {
            ...
            stateRestore: {
                ...
                duplicateError:
                    "وضعیتی با این نام از پیش ذخیره شده.",
