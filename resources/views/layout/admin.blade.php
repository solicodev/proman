...
<head>
    ...
    <!-- FAVICON -->
{{--    @if($setting->fav_icon)<link rel="shortcut icon" type="image/x-icon" href="{{ url($setting->fav_icon) }}" />@endif--}}
    ...
    <!--- FONT-ICONS CSS -->
    <link href="{{ url('assets/admin/plugins/icons/icons.css') }}" rel="stylesheet" />

    <!-- INTERNAL Switcher css -->
    <link href="{{ url('assets/admin/switcher/css/switcher.css') }}" rel="stylesheet">
    <link href="{{ url('assets/admin/switcher/demo.css') }}" rel="stylesheet">
    <link href="{{ url('assets/admin/css/jgrowl.min.css') }}" rel="stylesheet" />
    <link rel="stylesheet" href="{{ url('assets/admin/j_date/kamadatepicker.min.css') }}">
    <link href="{{ url('assets/admin/css/my_style.css') }}" rel="stylesheet" />
    <link rel="stylesheet" href="{{ asset('assets/panel/css/persian-datepicker.min.css') }}">

    @stack('stylesheets')
</head>

<body class="app sidebar-mini rtl dark-mode bg-img1">
                                ...
                                <div class="switch-toggle">
                                    ...
                                    <div class="mt-1">
                                        <a class="bg-img bg-img1" href="javascript:void(0);"><img
                                                src="{{ url('assets/admin/images/media/bg-img1.jpg') }}" alt="Bg-Image" id="bgimage1"></a>
                                        <a class="bg-img bg-img2" href="javascript:void(0);"><img
                                                src="{{ url('assets/admin/images/media/bg-img2.jpg') }}" alt="Bg-Image" id="bgimage2"></a>
                                        <a class="bg-img bg-img3" href="javascript:void(0);"><img
                                                src="{{ url('assets/admin/images/media/bg-img3.jpg') }}" alt="Bg-Image" id="bgimage3"></a>
                                        <a class="bg-img bg-img4" href="javascript:void(0);"><img
                                                src="{{ url('assets/admin/images/media/bg-img4.jpg') }}" alt="Bg-Image" id="bgimage4"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
{{--                            <img src="{{ url($setting->logo_footer) }}" class="header-brand-img desktop-logo" alt="logo">--}}
{{--                        @endif--}}
{{--                        @if($setting->logo_footer)--}}
{{--                            <img src="{{ url($setting->logo_footer) }}" class="header-brand-img light-logo1" alt="logo">--}}
{{--                        @endif--}}
                    </a>
                    <!-- LOGO -->
...
{{--                                                    <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{ url('assets/admin/images/users/1.jpg') }}"></span>--}}
{{--                                                    <div class="wd-90p">--}}
{{--                                                        <div class="d-flex">--}}
...
{{--                                                </a>--}}
{{--                                                <a class="dropdown-item d-flex" href="chat.html">--}}
{{--														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{ url('assets/admin/images/users/15.jpg') }}">--}}
{{--														</span>--}}
{{--                                                    <div class="wd-90p">--}}
{{--                                                        <div class="d-flex">--}}
...
{{--                                                </a>--}}
{{--                                                <a class="dropdown-item d-flex" href="chat.html">--}}
{{--														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{ url('assets/admin/images/users/12.jpg') }}">--}}
{{--														</span>--}}
{{--                                                    <div class="wd-90p">--}}
{{--                                                        <div class="d-flex">--}}
...
{{--                                                </a>--}}
{{--                                                <a class="dropdown-item d-flex" href="chat.html">--}}
{{--														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{ url('assets/admin/images/users/4.jpg') }}">--}}
{{--														</span>--}}
{{--                                                    <div class="wd-90p">--}}
{{--                                                        <div class="d-flex">--}}
...
{{--                                    <!-- NOTIFICATIONS -->--}}
                                    <div class="dropdown d-md-flex profile-1">
                                        <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
												<span>
{{--													@if(Auth::user()->photo)<img src="{{ url(Auth::user()->photo) }}" alt="profile-user"--}}
{{--                                                         class="avatar  profile-user brround cover-image">@endif--}}
												</span>
...
{{--                        @if($setting->logo_footer)<img src="{{ url($setting->logo_footer) }}" class="header-brand-img desktop-logo" alt="logo">@endif--}}
{{--                        @if($setting->fav_icon)<img src="{{ url($setting->fav_icon) }}" class="header-brand-img toggle-logo" alt="logo">@endif--}}
{{--                        @if($setting->logo_footer)<img src="{{ url($setting->logo_footer) }}" class="header-brand-img light-logo" alt="logo">@endif--}}
{{--                        @if($setting->logo_footer)<img src="{{ url($setting->logo_footer) }}" class="header-brand-img light-logo1" alt="logo">@endif--}}
                    </a><!-- LOGO -->
                </div>
...
{{--                            @if(auth()->user()->hasrole('Super Admin'))--}}
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">نمایندگان</span><i class="angle fa fa-angle-right"></i>
                            </a>
                            <ul class="slide-menu">
                                <li class="side-menu-label1"><a href="javascript:void(0)">نمایندگان</a></li>
                                <li><a href="" class="slide-item">لیست نمایندگان</a></li>
                                <li><a href="" class="slide-item">افزودن نماینده</a></li>
                            </ul>
                        </li>

                        <li>
                            <h3>مدیریت سایر بخش ها</h3>
                        </li>

{{--                        @can('role_permission')--}}
{{--                            <li class="slide">--}}
{{--                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('role-permission.index') }}">--}}
...
{{--                                        <span class="side-menu__label">مدیریت صفحات</span><i class="angle fa fa-angle-right"></i>--}}
{{--                                    </a>--}}
{{--                                    <ul class="slide-menu">--}}
{{--                                        <li class="side-menu-label1"><a href="javascript:void(0)">مدیریت صفحات</a></li>--}}
{{--                                        <li><a href="{{ route('admin.home-edit') }}" class="slide-item">مدیریت صفحه اصلی</a></li>--}}
{{--                                        <li><a href="{{ route('ContactPage.index') }}" class="slide-item">مدیریت صفحه تماس با ما</a></li>--}}
{{--                                        <li><a href="{{ route('admin.about_us') }}" class="slide-item">مدیریت صفحه درباره ما</a></li>--}}
{{--                                        <li><a href="{{ route('admin.term') }}" class="slide-item">مدیریت قوانین و مقررات</a></li>--}}
{{--                                        @if(\Nwidart\Modules\Facades\Module::has('Faq') and \Nwidart\Modules\Facades\Module::isEnabled('Faq'))--}}
{{--                                            <li><a href="{{ route('faq.index') }}" class="slide-item">سوالات متداول</a></li>--}}
{{--                                        @endif--}}
{{--                                    </ul>--}}
{{--                                </li>--}}
{{--                            @endcan--}}
{{--                            @if(\Nwidart\Modules\Facades\Module::has('Blogs') and \Nwidart\Modules\Facades\Module::isEnabled('Blogs'))--}}
{{--                                @can('blogs')--}}
{{--                                    <li class="slide">--}}
{{--                                        <a class="side-menu__item" data-bs-toggle="slide" href="#">--}}
{{--                                            <i class="fe fe-file-text side-menu__icon"></i>--}}
{{--                                            <span class="side-menu__label">مقالات</span><i class="angle fa fa-angle-right"></i>--}}
{{--                                        </a>--}}
{{--                                        <ul class="slide-menu">--}}
{{--                                            <li class="side-menu-label1"><a href="javascript:void(0)">مقالات</a></li>--}}
{{--                                            <li><a href="{{ route('BlogCategory.index') }}" class="slide-item">دسته بندی مقالات</a></li>--}}
{{--                                            <li><a href="{{ route('blogs.index') }}" class="slide-item">مدیریت مقالات</a></li>--}}
{{--                                            <li><a href="{{ route('tags.index') }}" class="slide-item">مدیریت تگ های مقالات</a></li>--}}
{{--                                        </ul>--}}
{{--                                    </li>--}}
{{--                                @endcan--}}
{{--                            @endif--}}
...
{{--                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">--}}
{{--                                        <i class="fe fe-file-text side-menu__icon"></i>--}}
{{--                                        <span class="side-menu__label">گزینه های بوم گردی</span><i class="angle fa fa-angle-right"></i>--}}
{{--                                    </a>--}}
{{--                                    <ul class="slide-menu">--}}
{{--                                        <li class="side-menu-label1"><a href="javascript:void(0)">گزینه های بوم گردی</a></li>--}}
{{--                                        <li><a href="{{ route('admin.ecotourism-option-category.index') }}" class="slide-item">دسته بندی ها</a></li>--}}
{{--                                        <li><a href="{{ route('admin.ecotourism-option.index') }}" class="slide-item">گزینه ها</a></li>--}}
{{--                                    </ul>--}}
{{--                                </li>--}}
{{--                            @endcan--}}

{{--                            @if(\Nwidart\Modules\Facades\Module::has('Tickets') and \Nwidart\Modules\Facades\Module::isEnabled('Tickets'))--}}
{{--                                @can('tickets')--}}
{{--                                    <li class="slide">--}}
{{--                                        <a class="side-menu__item" data-bs-toggle="slide" href="#">--}}
{{--                                            <i class="fa fa-ticket side-menu__icon"></i>--}}
{{--                                            <span class="side-menu__label">تیکت ها</span><i class="angle fa fa-angle-right"></i>--}}
{{--                                        </a>--}}
{{--                                        <ul class="slide-menu">--}}
{{--                                            <li class="side-menu-label1"><a href="javascript:void(0)">تیکت ها</a></li>--}}
{{--                                            <li><a href="{{ route('ticketDepartment.index') }}" class="slide-item">مدیریت دپارتمان ها</a></li>--}}
{{--                                            <li><a href="{{ route('tickets.index') }}" class="slide-item">مدیریت تیکت ها</a></li>--}}
{{--                                        </ul>--}}
{{--                                    </li>--}}
{{--                                @endcan--}}
{{--                            @endif--}}
...
{{--                                        <span class="side-menu__label">آموزش ها (راهنما)</span><i class="angle fa fa-angle-right"></i>--}}
{{--                                    </a>--}}
{{--                                    <ul class="slide-menu">--}}
{{--                                        <li class="side-menu-label1"><a href="javascript:void(0)">آموزش ها (راهنما)</a></li>--}}
{{--                                        <li><a href="{{ route('guide.index') }}" class="slide-item">مدیریت آموزش ها</a></li>--}}
{{--                                        <li><a href="{{ route('guide.create') }}" class="slide-item">افزودن آموزش</a></li>--}}
{{--                                    </ul>--}}
{{--                                </li>--}}
{{--                            @endcan--}}
{{--                            @can('guides')--}}
...
{{--                                        <span class="side-menu__label">پیام ها</span><i class="angle fa fa-angle-right"></i>--}}
{{--                                    </a>--}}
{{--                                    <ul class="slide-menu">--}}
{{--                                        <li class="side-menu-label1"><a href="javascript:void(0)">اطلاعیه ها</a></li>--}}
{{--                                        <li><a href="{{ route('notification.index') }}" class="slide-item">مدیریت اطلاعیه ها</a></li>--}}
{{--                                        <li><a href="{{ route('notification.create') }}" class="slide-item">افزودن اطلاعیه</a></li>--}}
{{--                                    </ul>--}}
{{--                                </li>--}}
{{--                            @endcan--}}
...
{{--                            @can('banner')--}}
{{--                                <li class="slide">--}}
{{--                                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('banner.index') }}">--}}
{{--                                        <i class="fa fa-image side-menu__icon"></i>--}}
{{--                                        <span class="side-menu__label">بنر ها</span>--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                            @endcan--}}

{{--                            @if(\Nwidart\Modules\Facades\Module::has('Socials') and \Nwidart\Modules\Facades\Module::isEnabled('Socials'))--}}
{{--                                @can('socials')--}}
{{--                                    <li class="slide">--}}
{{--                                        <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('socials.index') }}">--}}
{{--                                            <i class="fa fa-android side-menu__icon"></i>--}}
{{--                                            <span class="side-menu__label">شبکه های اجتماعی</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                @endcan--}}
{{--                            @endif--}}

{{--                            @if(\Nwidart\Modules\Facades\Module::has('Base') and \Nwidart\Modules\Facades\Module::isEnabled('Base'))--}}
{{--                                @can('newsletters')--}}
{{--                                    <li class="slide">--}}
{{--                                        <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('newsletter.index') }}">--}}
{{--                                            <i class="fa fa-newspaper-o side-menu__icon"></i>--}}
...
{{--                                            <span class="side-menu__label">تماس با ما</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
...
{{--                                @can('comments')--}}
{{--                                    <li class="slide">--}}
{{--                                        <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('comment.index') }}">--}}
{{--                                            <i class="fa fa-comment side-menu__icon"></i>--}}
{{--                                            <span class="side-menu__label">دیدگاه کاربران</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                @endcan--}}
{{--                                    <li>--}}
{{--                                        <h3>تنظیمات و دسترسی ها</h3>--}}
{{--                                    </li>--}}
{{--                                @can('setting')--}}
{{--                                    <li class="slide">--}}
{{--                                        <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('setting.index') }}">--}}
...
{{--                                @if(auth()->user()->seller)--}}
{{--                                    <li class="slide">--}}
{{--                                        <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('sellerProduct.index', auth()->user()->seller->id) }}">--}}
...
{{--                                </li>--}}
{{--                                <li class="slide">--}}
{{--                                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('amazing') }}">--}}
{{--                                        <i class="fa fa-percent side-menu__icon"></i>--}}
{{--                                        <span class="side-menu__label">پیشنهاد شگفت انگیز</span>--}}
{{--                                    </a>--}}
{{--                                </li>--}}

{{--                                    @if(\Nwidart\Modules\Facades\Module::has('Shop') and \Nwidart\Modules\Facades\Module::isEnabled('Shop'))--}}
{{--                                        @can('shop')--}}
{{--                                            <li class="slide">--}}
{{--                                                <a class="side-menu__item" data-bs-toggle="slide" href="#">--}}
{{--                                                    <i class="fa fa-line-chart side-menu__icon"></i>--}}
{{--                                                    <span class="side-menu__label">گزارشات</span><i class="angle fa fa-angle-right"></i>--}}
{{--                                                </a>--}}
{{--                                                <ul class="slide-menu">--}}
{{--                                                    <li class="side-menu-label1"><a href="javascript:void(0)">گزارشات</a></li>--}}
{{--                                                    <li><a href="{{ route('sales-report') }}" class="slide-item">گزارش فروش</a></li>--}}
{{--                                                    <li><a href="{{ route('financial-report') }}" class="slide-item">گزارش مالی</a></li>--}}
{{--                                                </ul>--}}
{{--                                            </li>--}}
{{--                                        @endcan--}}
{{--                                    @endif--}}
                    ...
                    <ul class="row row-sm p-3">
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block active">
                                <span class="country-selector"><img alt="unitedstates" src="{{ url('assets/admin/images/flags/us_flag.jpg') }}" class="me-2 language"></span>United States
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="italy" src="{{ url('assets/admin/images/flags/italy_flag.jpg') }}" class="me-2 language"></span>Italy
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="spain" src="{{ url('assets/admin/images/flags/spain_flag.jpg') }}" class="me-2 language"></span>Spain
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="india" src="{{ url('assets/admin/images/flags/india_flag.jpg') }}" class="me-2 language"></span>India
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="french" src="{{ url('assets/admin/images/flags/french_flag.jpg') }}" class="me-2 language"></span>French
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="russia" src="{{ url('assets/admin/images/flags/russia_flag.jpg') }}" class="me-2 language"></span>Russia
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="germany" src="{{ url('assets/admin/images/flags/germany_flag.jpg') }}" class="me-2 language"></span>Germany
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="argentina" src="{{ url('assets/admin/images/flags/argentina_flag.jpg') }}" class="me-2 language"></span>Argentina
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="uae" src="{{ url('assets/admin/images/flags/uae_flag.jpg') }}" class="me-2 language"></span>UAE
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="austria" src="{{ url('assets/admin/images/flags/austria_flag.jpg') }}" class="me-2 language"></span>Austria
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="mexico" src="{{ url('assets/admin/images/flags/mexico_flag.jpg') }}" class="me-2 language"></span>Mexico
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="china" src="{{ url('assets/admin/images/flags/china_flag.jpg') }}" class="me-2 language"></span>China
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="poland" src="{{ url('assets/admin/images/flags/poland_flag.jpg') }}" class="me-2 language"></span>Poland
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="canada" src="{{ url('assets/admin/images/flags/canada_flag.jpg') }}" class="me-2 language"></span>Canada
                            </a>
                        </li>
                        <li class="col-lg-4 mb-2">
                            <a class="btn btn-country btn-lg btn-block">
                                <span class="country-selector"><img alt="malaysia" src="{{ url('assets/admin/images/flags/malaysia_flag.jpg') }}" class="me-2 language"></span>Malaysia
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 d-flex mb-4">
                            ...
                            <div class="m-0 wp-70 text-dark d-flex align-items-center">
                                <div class="me-2">
                                    <img alt="User Avatar" class="rounded-circle avatar-sm" src="{{ url('assets/admin/images/users/7.jpg') }}">
                                </div>
                                <div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img alt="User Avatar" class="rounded-circle avatar-md" src="{{ url('assets/admin/images/users/8.jpg') }}">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img alt="User Avatar" class="rounded-circle avatar-md" src="{{ url('assets/admin/images/users/2.jpg') }}">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img alt="User Avatar" class="rounded-circle avatar-md" src="{{ url('assets/admin/images/users/11.jpg') }}">
                                                </div>
                                                <div>
                                    ...
                                    <tr class="row-last">
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img alt="User Avatar" class="rounded-circle avatar-lg" src="{{ url('assets/admin/images/users/14.jpg') }}">
                                                </div>
                                                <div>
                            ...
                            <div class="row">
                                <div class="mt-5">
                                    <div class="media mb-5 overflow-visible">
                                        <div class="me-3">
                                            <a href="profile.html"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="{{ url('assets/admin/images/users/5.jpg') }}"> </a>
                                        </div>
                                        <div class="media-body overflow-visible">
                                            ...
                                            <div class="media mb-5 overflow-visible">
                                                <div class="me-3">
                                                    <a href="profile.html"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="{{ url('assets/admin/images/users/2.jpg') }}"> </a>
                                                </div>
...
<!-- CHART-CIRCLE JS-->
<script src="{{ url('assets/admin/plugins/circle-progress/circle-progress.min.js') }}"></script>
...
<!-- FORMVALIDATION JS -->
<script src="{{ url('assets/admin/js/form-validation.js') }}"></script>
...
<!-- Reply JS-->
<script src="{{ url('assets/admin/js/reply.js') }}"></script>

<!-- Internal Input tags js-->
<script src="{{ url('assets/admin/plugins/inputtags/inputtags.js') }}"></script>
...
<script src="{{ url('assets/admin/js/jgrowl.min.js') }}"></script>

<!-- SWITCHER JS -->
<script src="{{ url('assets/admin/switcher/js/switcher.js') }}"></script>

<script src="{{ url('assets/admin/j_date/kamadatepicker.min.js') }}"></script>
<script src="{{ url('assets/admin/js/my_scripts.js') }}"></script>

<!-- INTERNAL Summernote Editor js -->
<script src="{{url('assets/admin/plugins/summernote-editor/summernote1.js')}}"></script>
<script src="{{url('assets/admin/js/summernote.js')}}"></script>

<!--Internal Fileuploads js-->

<script src="{{url('assets/admin/plugins/fancyuploder/jquery.ui.widget.js')}}"></script>
<script src="{{url('assets/admin/plugins/fancyuploder/jquery.fileupload.js')}}"></script>
<script src="{{url('assets/admin/plugins/fancyuploder/jquery.iframe-transport.js')}}"></script>
<script src="{{url('assets/admin/plugins/fancyuploder/jquery.fancy-fileupload.js')}}"></script>
<script src="{{url('assets/admin/plugins/fancyuploder/fancy-uploader.js')}}"></script>
<script src="{{url('assets/admin/plugins/fileuploads/js/fileupload.js')}}"></script>
<script src="{{url('assets/admin/plugins/fileuploads/js/file-upload.js')}}"></script>
...
<script src="{{url('assets/admin/plugins/counters/counters-1.js')}}"></script>
<script src="{{ asset('assets/panel/js/persian-date.min.js') }}"></script>
<script src="{{ asset('assets/panel/js/persian-datepicker.min.js') }}"></script>
<script>
