                        ...
                        <div class="card">
                            <div class="card-body my-5">
                                <div class="title-head my-3">
                                    <h3 class="mb-5 card-title"> پیام </h3>
                                    <div class="storage-percent">
                                        ...
                                        <div class="remaining-storage">
                                            <div class="text-muted fs-13 mb-1 mt-3">کل ارسال ها</div>
                                            <div class="fw-semibold fs-14 mb-1 mt-3"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="content-main my-5">
                                    <ul class="task-list1 row mx-auto">
                                        <li class="col-xl-6">
                                            <span class="mb-0 fs-13 me-1"><i class="task-icon1 bg-primary me-3"></i>تست 1</span>
                                        ...
                                        <li class="col-xl-6">
                                            <span class="mb-0 fs-13 me-1"><i class="task-icon1 bg-secondary"></i>تست 2</span>
                                        ...
                                        <li class="col-xl-6">
                                            <span class="mb-0 fs-13 me-1"><i class="task-icon1 bg-custom-yellow"></i>تست 3</span>
                                            <span class="text-success fw-semibold fs-12">
                                                                    <span class="mx-1"><i class="fa fa-caret-up"></i></span>
                                                                    <span class=""></span>
                                                                </span>
                                        ...
                                        <li class="col-xl-6 mb-xl-0">
                                            <span class="mb-0 fs-13 me-1"><i class="task-icon1 bg-teritary"></i>تست 4 </span>
                                            <span class="text-success fw-semibold fs-12">
                                                                    <span class="mx-1"><i class="fa fa-caret-up"></i></span>
                                                                    <span class=""></span>
                                                                </span>
                                    ...
                                    <a href="" class="btn btn-outline-success btn-lg btn-block my-3"></a>
                                </div>
                            </div>
                        </div>
                    </div>
