            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('users.update',$user->id) }}" method="post" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>

                            @method("PUT")
                            <div class="col-md-6">
                                <label for="first_name" class="form-label">نام</label>
                                <input type="text" name="first_name" class="form-control" id="first_name" required value="{{ old('first_name',$user->first_name) }}">
                                <div class="invalid-feedback">لطفا نام خود را وارد کنید</div>
                            </div>

                            <div class="col-md-6">
                                <label for="last_name" class="form-label">نام خانوادگی</label>
                                <input type="text" name="last_name" class="form-control" id="last_name" required value="{{ old('last_name',$user->last_name) }}">
                                <div class="invalid-feedback">لطفا نام خانوادگی را وارد کنید</div>
                            </div>

                            <div class="col-md-6">
                                <label for="mobile" class="form-label">شماره تماس</label>
                                <input type="text" name="mobile" class="form-control" id="mobile" required value="{{ old('mobile',$user->mobile) }}">
                            ...
                            <div id="role" class="col-md-6">
                                ...
                                <select name="role" class="form-control" required>
                                    ...
                                    @foreach($roles as $role)
                                        <option value="{{ $role->name }}" @if($user->getRoleNames()->first() == $role->name) selected="selected" @endif>{{ $role->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-control" required>
                                    ...
                                    <option value="inactive" @if($user->status == 'inactive') selected @endif>غیر فعال</option>
                                </select>
                            ...
                            <div class="col-md-1">
                                @if($user->photo)
                                    ...
                                    <img src="{{ url($user->photo) }}" style="max-width: 50%;">
                                @endif
                            </div>
