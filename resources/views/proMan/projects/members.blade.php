<x-layout>
    ...
    <div class="d-flex flex-wrap flex-stack pb-7">
        ...
        <div class="d-flex flex-wrap align-items-center my-1">
            <h3 class="fw-bold me-5 my-1">تعداد اعضای پروژه ({{$project_members->count()}})</h3>

            <!--begin::Search-->
            <div class="d-flex align-items-center position-relative my-1">
                <i class="ki-outline ki-magnifier fs-3 position-absolute ms-3"></i>
                <input type="text" id="kt_filter_search" class="form-control form-control-sm border-body bg-body w-150px ps-10" placeholder="جستجو"/>
            </div>
            <!--end::Search-->
        </div>
        <!--end::Title-->
...
{{--                </li>--}}
            ...
            <div class="d-flex my-0">
                ...
                <select name="status" data-control="select2" data-hide-search="true" data-placeholder="Filter"  class="form-select form-select-sm border-body bg-body w-150px me-5">
                    ...
                    <option value="4">سال اخیر</option>
                </select>
                <!--end::Select-->
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                            ...
                            <div class="symbol symbol-65px symbol-circle mb-5">
                                @if($member->photo_id)
                                    <img src="{{route('home')}}/{{$member->photo?->path}}" alt="image" />
                                @else
                                    <span class="symbol-label fs-2x fw-semibold text-primary bg-light-primary">{{ mb_substr($member->Name, 0, 1) }}</span>
                                @endif
                            ...
                            <!--begin::Position-->
                            <div class="fw-semibold text-gray-500 mb-6">{{role_name($member->getRoleNames()->first())}}</div>
                            <!--end::Position-->
                            ...
                            <div class="d-flex flex-center flex-wrap">
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                    <div class="fs-6 fw-bold text-gray-700">{{$files->count()}}</div>
                                    <div class="fw-semibold text-gray-500">کل فایل ها</div>
                                </div>
                                <!--end::Stats-->

                                <!--begin::Stats-->
                                <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                    <div class="fs-6 fw-bold text-gray-700">{{$task_member->count()}}</div>
                                    <div class="fw-semibold text-gray-500">تسک های مربوط</div>
                                </div>
                                <!--end::Stats-->

                                <!--begin::Stats-->
                                <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                    <div class="fs-6 fw-bold text-gray-700">{{$activities->count()}}</div>
                                    <div class="fw-semibold text-gray-500">کل فعالیت ها</div>
                                </div>
                                <!--end::Stats-->
                            </div>
                            <!--end::Info-->
...
{{--                                <th class="text-start">تعداد فعالیت ها</th>--}}
{{--                                <th class="text-start">تعداد تسک ها</th>--}}
{{--                                <th class="text-start">تعداد فایل ها</th>--}}
...
{{--                                            <a href="#" class="mb-1 text-gray-800 text-hover-primary">{{$member->Name}}</a>--}}
